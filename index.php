            ...
            <?php foreach ($catalogue->getAllProducts() as $product): ?>
                <div class="product">
                    ...
                    <form action="product-info.php" method="GET">
                      <input type="submit" class="cart-button" value="info - <?php echo $product->getTitle() ?>">
                      <input style="display: none;" type="text" name="product_info" value="<?php echo $product->getCode() ?>">
                    </form>
                </div>
            <?php endforeach; ?>
        </div>
